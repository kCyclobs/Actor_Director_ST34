        ...
        <div class="profile__content">
            ...
            <div class="profile__user">
                <div class="profile__avatar">
                    <img src="<?php echo e(Auth::user()->profile ? url('profile/' . Auth::user()->profile) : url('img/user.svg')); ?>" alt="" id="update_profile_pic">
                ...
                <div class="profile__meta profile__meta--green">
                    ...
                    <h3><?php echo e(Auth::user()->name); ?> 
                        <span>(<?php echo e((Auth::user()->status) ? 'Approved' : 'Block'); ?>)</span>
                    </h3>
                    <span>FlixTV ID: <?php echo e(Auth::user()->id); ?> </span>
                </div>
            </div>
            <!-- end profile user -->
                ...
                <div class="sign__wrap">
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-6">
                            <form action="<?php echo e(route('save')); ?>" method="POST"  class="sign__form sign__form--profile sign__form--first">
                                <?php echo csrf_field(); ?>
                                <div class="row">
                                    <div class="col-12">
                                    ...
                                    <div class="col-12 col-md-6 col-lg-12 col-xl-6">
                                        <div class="sign__group">
                                            ...
                                            <input id="name" type="text" name="name" class="sign__input" value="<?php echo e(Auth::User()->name); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-6 col-lg-12 col-xl-6">
                                        <div class="sign__group">
                                            ...
                                            <input id="email" type="text" name="email" class="sign__input" value="<?php echo e(Auth::User()->email); ?>" readonly>
                                        </div>
                                    </div>
                        ...
                        <div class="col-12 col-lg-6" id="changePassword">
                            <form method="POST" action="<?php echo e(route('password.update')); ?>"  class="sign__form sign__form--profile" >
                                <?php echo csrf_field(); ?>
                                <div class="row">
                                    <div class="col-12">
...
<?php echo $__env->make('admin.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/gakvicheka/Documents/movie/movie/resources/views/user/profile.blade.php ENDPATH**/ ?>