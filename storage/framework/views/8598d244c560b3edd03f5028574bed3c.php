<?php $__env->startSection('main'); ?>
    <!-- registration form -->
        <form action="<?php echo e(route('register')); ?>" class="sign__form" method="POST">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?> 
            ...
            <span class="sign__text">Already have an account? <a href="<?php echo e(route("login")); ?>">Sign in!</a></span>
        </form>
    <!-- registration form -->
...
<?php echo $__env->make('auth.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/gakvicheka/Documents/movie/movie/resources/views/auth/register.blade.php ENDPATH**/ ?>