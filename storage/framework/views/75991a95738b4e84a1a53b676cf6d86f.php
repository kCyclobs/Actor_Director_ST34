<?php $__env->startSection('main'); ?>
    <!-- registration form -->
        <form action="<?php echo e(route('login')); ?>" class="sign__form" method="POST">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?> 
            ...
            <span class="sign__text">Not have an account? <a href="<?php echo e(route ("register")); ?>">Sign Up!</a></span>
            <span class="sign__text">Not have Remember Password? 
                <a href="<?php echo e(route ("password.request")); ?>">reset now</a></span>
        </form>
    <!-- registration form -->
<?php $__env->stopSection(); ?>
<?php echo $__env->make('auth.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/gakvicheka/Documents/movie/movie/resources/views/auth/login.blade.php ENDPATH**/ ?>